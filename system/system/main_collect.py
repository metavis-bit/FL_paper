...
def run(args):
    ...
    for algo in [ "SCAFFOLD", "Adap-CTA", "DPFedAvg", "FedMut", "FedPVR", "HEFedAvg", "FedCEO", "AdapLDP-FL"]:
...
if __name__ == "__main__":
    ...
    parser.add_argument('-mn', "--model_name", type=str, default="VGG11")
    ...
    parser.add_argument('-algo', "--algorithm", type=str, default="DP-FedAvg")
    parser.add_argument('-jr', "--join_ratio", type=float, default=0.1, help="Ratio of clients per round")
    parser.add_argument('-nv', "--noise_multiplier", type=float, default=0.001, help="noise variance")
    ...
    parser.add_argument('--mut_acc_rate', type=float, default=0.3,
                        help='learning rate')
    parser.add_argument("--mut_bound", type=int, default=20)
    parser.add_argument('--MutAlpha', type=float, default=2.0)
