...
def generate_cifar10(dir_path, num_clients, num_classes, niid, balance, partition,class_per_client,alpha):
    ...
    trainset = torchvision.datasets.CIFAR10(
        root=rawdata_path+"rawdata", train=True, download=True, transform=transform)

    testset = torchvision.datasets.CIFAR10(
        root=rawdata_path+"rawdata", train=False, download=True, transform=transform)
